import {
  AuthokClient as SpaAuthokClient,
  AuthokClientOptions,
...
import { AuthokVueClient, AppState } from './interfaces';

/**
 * @ignore
 */
export const createAuthokClientProxy = (
  options: AuthokClientOptions
): AuthokVueClient => {
  const client = new SpaAuthokClient(options);
