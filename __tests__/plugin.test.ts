...
import { AUTHOK_INJECTION_KEY, createAuthok, useAuthok } from '../src/index';
...
jest.mock('@authok/authok-spa-js', () => {
  return {
    AuthokClient: jest.fn().mockImplementation(() => {
      return {
...
describe('createAuthok', () => {
  it('should create a plugin', async () => {
    const plugin = createAuthok({
      domain: '',
      client_id: ''
    });
...
describe('useAuthok', () => {
  it('should call inject', async () => {
    ...
    const result = useAuthok();
    expect(result).toBe(instance);
  });
});

describe('AuthokPlugin', () => {
  ...
  it('should create a proxy on installation', async () => {
    ...
    expect(appMock.config.globalProperties.$authok).toBeTruthy();
    expect(appMock.provide).toHaveBeenCalledWith(
      AUTHOK_INJECTION_KEY,
      expect.anything()
    );
    expect(AuthokClient).toHaveBeenCalledWith(
  ...
  it('should proxy loginWithRedirect', async () => {
    ...
    await appMock.config.globalProperties.$authok.loginWithRedirect(
      loginOptions
    );
  ...
  it('should proxy loginWithPopup', async () => {
    ...
    await appMock.config.globalProperties.$authok.loginWithPopup(
      loginOptions,
      popupOptions
    );
  ...
  it('should proxy logout', async () => {
    ...
    await appMock.config.globalProperties.$authok.logout(logoutOptions);
  ...
  it('should proxy logout without options', async () => {
    ...
    await appMock.config.globalProperties.$authok.logout();
  ...
  it('should proxy getAccessTokenSilently', async () => {
    ...
    await appMock.config.globalProperties.$authok.getAccessTokenSilently(
      getTokenOptions
    );
  ...
  it('should proxy getAccessTokenWithPopup', async () => {
    ...
    await appMock.config.globalProperties.$authok.getAccessTokenWithPopup(
      getTokenOptions,
      popupOptions
    );
  ...
  it('should proxy buildAuthorizeUrl', async () => {
    ...
    await appMock.config.globalProperties.$authok.buildAuthorizeUrl(
      loginOptions
    );
  ...
  it('should proxy buildLogoutUrl', async () => {
    ...
    await appMock.config.globalProperties.$authok.buildLogoutUrl(
      logoutUrlOptions
    );
  ...
  it('should be loading by default', async () => {
    ...
    expect(appMock.config.globalProperties.$authok.isLoading.value).toBe(true);
  });
  ...
  it('should not be loading once the SDK is finished', async () => {
    ...
    return flushPromises().then(() => {
      expect(appMock.config.globalProperties.$authok.isLoading.value).toBe(
        false
      );
    });
  });
  ...
  it('should set isAuthenticated to false when not authenticated', async () => {
    ...
    return flushPromises().then(() => {
      expect(
        appMock.config.globalProperties.$authok.isAuthenticated.value
      ).toBe(false);
    });
  });
  ...
  it('should set user to null when not authenticated', async () => {
    ...
    return flushPromises().then(() => {
      expect(appMock.config.globalProperties.$authok.user.value).toBe(null);
    });
  });
  ...
  it('should set user when authenticated', async () => {
    ...
    return flushPromises().then(() => {
      expect(appMock.config.globalProperties.$authok.user.value).toStrictEqual(
        userMock
      );
    });
  });
  ...
  it('should set idTokenClaims to null when not authenticated', async () => {
    ...
    return flushPromises().then(() => {
      expect(appMock.config.globalProperties.$authok.idTokenClaims.value).toBe(
        null
      );
    });
  });
  ...
  it('should set idTokenClaims when authenticated', async () => {
    ...
    return flushPromises().then(() => {
      expect(
        appMock.config.globalProperties.$authok.idTokenClaims.value
  ...
  it('should track errors when loginWithPopup throws', async () => {
    ...
    expect(appMock.config.globalProperties.$authok.error.value).toEqual(
      'Some Error'
    );
  });
  ...
  it('should track errors when checkSession throws', async () => {
    ...
    try {
      ...
      await appMock.config.globalProperties.$authok.checkSession();
    } catch (e) {}
  ...
  it('should track errors when handleRedirectCallback throws', async () => {
    ...
    try {
      await appMock.config.globalProperties.$authok.handleRedirectCallback();
    } catch (e) {}
  ...
  it('should clear errors when successful', async () => {
    ...
    expect(appMock.config.globalProperties.$authok.error.value).toBeFalsy();
  });
});
