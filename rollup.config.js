...
const footer = `('AuthOKClient' in this) && this.console && this.console.warn && this.console.warn('AuthOKClient already declared on the global namespace');
this && this.${EXPORT_NAME} && (this.AuthOKClient = this.AuthOKClient || this.${EXPORT_NAME}.AuthOKClient);`;
...
let bundles = [
  {
    ...
    output: {
      name: EXPORT_NAME,
      file: 'dist/authok-vue.development.js',
      footer,
      format: 'umd',
      sourcemap: true,
      exports: 'default',
...
if (isProduction) {
  bundles = bundles.concat(
    {
      ...
      output: [
        {
          name: EXPORT_NAME,
          file: 'dist/authok-vue.production.js',
          footer,
          format: 'umd',
          exports: 'default',
          globals: {
  ...
  bundles = bundles.concat({
    ...
    output: {
      format: 'umd',
      file: 'dist/authok-vue.playground.js',
      globals: {
        vue: 'Vue',
        'vue-router': 'VueRouter'
      }
